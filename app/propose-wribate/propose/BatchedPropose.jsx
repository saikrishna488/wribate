...
const BatchPropose = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post(process.env.NEXT_PUBLIC_BACKEND_URL+'/user/createbatchpropose',formData,{
        headers : authHeader() 
      });
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-200">
      <h3 className="text-xl font-semibold text-gray-800 mb-6">Batch Topic Proposal</h3>
          ...
          <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-400 transition-colors">
            ...
            <label htmlFor="fileUpload" className="cursor-pointer">
              <div className="text-gray-600">
                ...
                <p className="text-xs text-gray-500">Excel (.xlsx, .xls) or CSV files only</p>
              </div>
            </label>
          </div>
          {file && (
