...
const Comments = ({id}) => {
    ...
    const fetchComments = async() => {
        try {
            const data = await httpRequest(axios.get(process.env.NEXT_PUBLIC_BACKEND_URL+'/user/article/comments/'+id))
    ...
    const handleSubmitComment = async(e) => {
        ...
        try {
            ...
            await httpRequest(axios.post(process.env.NEXT_PUBLIC_BACKEND_URL+'/user/article/comment', {
                article_id: id,
                user_id: user?._id,
                text: newComment
            },{
    ...
    return (
        <div className="w-full mt-20 border-t-0 border-gray-200 p-2 bg-white">
