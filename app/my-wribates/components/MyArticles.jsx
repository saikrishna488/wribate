...
import { articleAtom, userAtom } from "@/app/states/GlobalStates";
...
function ArticlesTable() {
  ...
  const fetchArticles = async () => {
    ...
    const data = await httpRequest(axios.get(url + '/user/getarticlesbyuser', {
      headers: authHeader()
    }));
  ...
  const filteredArticles = Array.isArray(articles)
    ? articles.filter((article) => {
      const matchesSearch =
        ...
        // article.assigned_to_name?.toLowerCase().includes(searchTerm.toLowerCase()) ||
    ...
    <div className="min-h-screen  px-4">
      ...
      <div className="bg-white ">
        <div className="w-full mx-auto py-6">
          ...
          <p className="mt-1 text-sm text-gray-600">Manage and track all your articles</p>
        </div>
      </div>
                ...
                <div key={article._id} className="border border-gray-200 rounded-lg p-4 space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    ...
                    <div>
                      ...
                      <div className="font-medium">{article.assigned_to_name}</div>
                    </div>
                  </div>
