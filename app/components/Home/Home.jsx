...
import HeroWribate from './HeroWribate'
import SponsoredWribates from './SponsoredWribates'
import CompletedWribates from './CompleteWribates'
import FreeWribates from './FreeWribates'
import ActiveWribates from './ActiveWribates'
import OngoingWribates from './OngoingWribate'
...
export default function WribateDashboard() {
  ...
  return (
    <div ref={wribatesRef} className="min-h-screen bg-[#F3F2EF]">
      <Header
      ...
      <div className="w-full min-h-screen mx-auto flex py-2 flex-col lg:flex-row">
